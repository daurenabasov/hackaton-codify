      ...
      <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
        ...
        <div className="flex flex-row justify-between items-center w-full">
          <h1 className="flex-1 font-poppins font-semibold ss:text-[72px] text-[52px] text-purple-900		 ss:leading-[100.8px] leading-[75px]">
            Invest  and develop <br className="sm:block hidden" />{" "}
            <span className=" text-transparent text-6xl bg-clip-text bg-gradient-to-r from-purple-400 to-pink-900"> in your future</span>{" "}
          </h1>
        </div>
